...
const Home = () => {
  return (
    <div className="flex flex-col">
      ...
      {/* features */}
      <div className=" p-4 mt-20 lg:mt-5 w-full">
        <div className=" max-w-6xl mx-auto flex flex-col items-center sm:items-start sm:flex-row mb-24  gap-x-12 gap-y-8 w-full">
          {features.map((item) => (
            <Card
              imgUrl={item.imgUrl}
