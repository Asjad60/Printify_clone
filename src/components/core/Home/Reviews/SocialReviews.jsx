...
const SocialReviews = () => {
  ...
  return (
    <div className="bg-[#f7f7f7] p-10 lg:p-24 ">
      <div className="max-w-7xl mx-auto">
        <div className="flex gap-10 flex-col lg:flex-row items-center p-6">
        ...
        <div
          ref={containerRef}
          className="relative max-w-sm lg:max-w-7xl mx-auto w-11/12 flex justify-center mb-20"
        >
